...
class SalaryService {
public:
    int calculateSalary(int position) const {
        switch (position) {
        case HEAD:
            return 40000;
        case CHIEF_ENGINEER:
...
public:
    ...
    int calculateSalary() const {
        if (salaryService == nullptr) {
            return 0;
        }

        return salaryService->calculateSalary(position);
    }
    ...
    void showInformation() const {
        ...
        cout << "Salary: " << calculateSalary() << " UAH" << endl;
        cout << "-----------------------------\n";
    }
};
    ...
    do {
        ...
        case 2: {
            ...
            employees.emplace_back(
                ...
                position, experience, &salaryService
            );
